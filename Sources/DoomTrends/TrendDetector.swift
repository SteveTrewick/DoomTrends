...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "back", "bar", "be", "been", "before", "being", "blank", "border",
            "breaking", "business", "but", "by", "called", "calling", "car", "city",
            "claims", "coast", "customs", "damage", "death", "defends", "department",
            "disruption", "enforcement", "exclusive", "experience", "explore",
            "extension", "extending", "fatal", "fatally", "federal", "fire", "flight",
            "for", "force", "forces", "former", "forward", "from", "funding",
            "general", "get", "gets", "good", "got", "government", "guard", "has",
            "have", "he", "health", "held", "help", "her", "heres", "high", "his",
            "holds", "homeland", "homes", "host", "house", "how", "if", "in",
            "incident", "incidents", "including", "interview", "into",
            "investigation", "involved", "is", "issues", "it", "its", "jan", "joins",
            "judge", "know", "large", "late", "latest", "law", "leader", "leaders",
            "lead", "led", "life", "linked", "live", "major", "man", "mark", "massive",
            "me", "measure", "million", "more", "morning", "move", "my", "new", "news",
            "night", "no", "north", "not", "of", "off", "office", "officer", "officers",
            "official", "officials", "old", "on", "one", "opinion", "or", "our", "out",
            "over", "owner", "party", "pass", "patients", "plan", "power", "powers",
            "property", "prosecutor", "rate", "remains", "report", "reports",
            "response", "risk", "say", "says", "said", "second", "security", "seek",
            "sell", "services", "set", "she", "shes", "shut", "since", "so",
            ...
            "toward", "trumps", "under", "up", "update", "updates", "urged", "us",
            "vehicle", "vehicles", "vote", "was", "watch", "way", "we", "were", "what",
            "when", "where", "which", "who", "why", "winds", "with", "woman", "want",
            "you", "your",
            "near", "people",
