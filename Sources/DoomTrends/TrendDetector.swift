...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "by", "called", "calling", "came", "car", "changed", "chief", "child",
            "children", "citizens", "city", "claims", "closed", "coast", "cold",
            "concerns", "conditions", "continues", "couple", "customs", "damage",
            "death", "deadly", "defends", "denies", "department", "despite",
            "disruption", "downplay", "enforcement", "eve", "ex", "exclusive",
            "experience", "explore", "extension", "extending", "fatal", "fatally",
            "father", "federal", "fire", "first", "flight", "focus", "following",
            "for", "force", "forces", "former", "found", "forward", "four", "from",
            "fuels", "funding", "game", "general", "get", "gets", "going", "good",
            "got", "government", "growing", "guard", "has", "have", "he", "health",
            "held", "help", "her", "heres", "high", "his", "hit", "holds", "homeland",
            "homes", "host", "house", "how", "if", "in", "incident", "incidents",
            "including", "interview", "into", "investigation", "involved", "is",
            "issued", "issues", "it", "its", "jan", "joins", "judge", "key", "killing",
            "know", "large", "late", "latest", "law", "leader", "leaders", "lead",
            "led", "life", "like", "linked", "live", "major", "man", "mark", "massive",
            "me", "measure", "measures", "meeting", "media", "met", "million", "more",
            "morning", "move", "my", "new", "news", "next", "night", "no", "north",
            "not", "of", "off", "office", "officer", "officers", "official",
            "officials", "old", "on", "one", "opinion", "or", "our", "out", "over",
            "owner", "party", "pass", "patients", "peaceful", "plan", "point", "power",
            "powers", "previously", "property", "prosecutor", "rate", "really",
            "remains", "report", "reporter", "reports", "response", "return",
            "reveals", "review", "risk", "say", "says", "said", "scrutiny", "second",
            "security", "seek", "seems", "sell", "services", "set", "seizure", "she",
            "shes", "shut", "since", "side", "slams", "so", "sold", "sources",
            "spoke", "special", "star", "state", "stay", "still", "streets",
            "suffers", "support", "suspected", "taking", "takes", "talk", "talks",
            "target", "team", "tensions", "than", "that", "the", "their", "them",
            "then", "there", "these", "they", "this", "those", "three", "time", "to",
            "took", "toward", "trying", "trumps", "two", "turning", "under", "up",
            "update", "updates", "urged", "urges", "us", "use", "vehicle", "vehicles",
            "view", "vote", "warnings", "warns", "was", "watch", "way", "we", "were",
            "what", "when", "where", "which", "white", "who", "why", "winds", "with",
            "woman", "want", "you", "your",
            "near", "people",
