...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "his", "holds", "homeland", "homes", "host", "house", "how", "if", "in",
            ...
            "seems", "sell", "services", "set", "she", "shes", "shut", "since",
            "slams", "so", "sold", "sources", "spoke", "special", "star", "state",
            "stay", "still", "streets", "suffers", "support", "suspected", "taking",
            "takes", "talk", "talks", "target", "team", "tensions", "than", "that",
            "the", "their", "them", "then", "there", "these", "they", "this", "those",
            "time", "to", "took", "toward", "trying", "trumps", "two", "under", "up",
