...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "came", "car", "changed", "city", "claims", "closed", "coast", "concerns",
            "conditions", "customs", "damage", "death", "deadly", "defends",
            "department", "disruption", "enforcement", "eve", "exclusive",
            "experience", "explore", "extension", "extending", "fatal", "fatally",
            "father", "federal", "fire", "flight", "focus", "for", "force", "forces",
            "former", "found", "forward", "from", "funding", "general", "get", "gets",
            "good", "got", "government", "growing", "guard", "has", "have", "he",
            "health", "held", "help", "her", "heres", "high", "his", "holds",
            "homeland", "homes", "host", "house", "how", "if", "in", "incident",
            "incidents", "including", "interview", "into", "investigation", "involved",
            "is", "issues", "it", "its", "jan", "joins", "judge", "key", "killing",
            "know", "large", "late", "latest", "law", "leader", "leaders", "lead",
            "led", "life", "like", "linked", "live", "major", "man", "mark", "massive",
            "me", "measure", "measures", "meeting", "million", "more", "morning",
            "move", "my", "new", "news", "night", "no", "north", "not", "of", "off",
            "office", "officer", "officers", "official", "officials", "old", "on",
            "one", "opinion", "or", "our", "out", "over", "owner", "party", "pass",
            "patients", "plan", "power", "powers", "previously", "property",
            "prosecutor", "rate", "really", "remains", "report", "reporter", "reports",
            "response", "review", "risk", "say", "says", "said", "scrutiny", "second",
            "security", "seek", "seems", "sell", "services", "set", "she", "shes",
            "shut", "since", "slams", "so", "sold", "sources", "spoke", "special",
            "star", "state", "stay", "still", "streets", "suffers", "support",
            "suspected", "taking", "takes", "talk", "talks", "target", "team",
            "tensions", "than", "that", "the", "their", "them", "then", "there",
            "these", "they", "this", "those", "time", "to", "took", "toward", "trying",
            "trumps", "two", "under", "up", "update", "updates", "urged", "us", "use",
            "vehicle", "vehicles", "vote", "warns", "was", "watch", "way", "we",
            "were", "what", "when", "where", "which", "white", "who", "why", "winds",
            "with", "woman", "want", "you", "your",
            "near", "people",
