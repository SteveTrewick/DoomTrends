...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            "a", "about", "action", "actions", "after", "against", "all", "amid",
            "an", "and", "are", "areas", "as", "at", "be", "been", "before", "being",
            "blank", "breaking", "business", "but", "by", "calling", "customs",
            "defends", "department", "disruption", "enforcement", "explore", "federal",
            "for", "from", "get", "good", "government", "has", "have", "he", "her",
            "high", "his", "holds", "homeland", "how", "if", "in", "into", "is",
            "it", "its", "judge", "know", "late", "latest", "leader", "lead", "led",
            "live", "me", "million", "more", "morning", "my", "new", "night", "no",
            "not", "of", "off", "officer", "old", "on", "one", "opinion", "or", "our",
            "out", "over", "patients", "powers", "prosecutor", "rate", "report",
            "response", "say", "says", "said", "security", "she", "so", "spoke",
            "state", "target", "than", "that", "the", "their", "them", "then", "there",
            "these", "they", "this", "those", "to", "under", "up", "update", "updates",
            "us", "vehicle", "was", "watch", "way", "we", "were", "what", "when",
            "where", "which", "who", "why", "with", "woman", "you", "your",
            "near", "people",
