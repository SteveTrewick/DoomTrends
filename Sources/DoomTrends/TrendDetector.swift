...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "disruption", "enforcement", "explore", "fatal", "fatally", "federal",
            "for", "former", "from", "funding", "get", "gets", "good", "got",
            "government", "has", "have", "he", "health", "help", "her", "heres",
            "high", "his", "holds", "homeland", "host", "house", "how", "if", "in",
            "incident", "into", "investigation", "is", "it", "its", "joins", "judge",
            "know", "large", "late", "latest", "leader", "lead", "led", "live", "man",
            "massive", "me", "measure", "million", "more", "morning", "my", "new",
            "news", "night", "no", "not", "of", "off", "officer", "officers",
            "official", "old", "on", "one", "opinion", "or", "our", "out", "over",
            "party", "patients", "plan", "powers", "prosecutor", "rate", "report",
            "reports", "response", "say", "says", "said", "security", "seek",
            "services", "she", "shes", "so", "sources", "spoke", "state", "taking",
            "takes", "target", "talks", "tensions", "than", "that", "the", "their",
            "them", "then", "there", "these", "they", "this", "those", "to", "under",
            "up", "update", "updates", "urged", "us", "vehicle", "was", "watch",
            "way", "we", "were", "what", "when", "where", "which", "who", "why",
