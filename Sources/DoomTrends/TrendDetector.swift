...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "car", "city", "claims", "closed", "coast", "customs", "damage", "death",
            "deadly", "defends", "department", "disruption", "enforcement", "eve",
            "exclusive", "experience", "explore", "extension", "extending", "fatal",
            "fatally", "father", "federal", "fire", "flight", "for", "force",
            "forces", "former", "found", "forward", "from", "funding", "general",
            "get", "gets", "good", "got", "government", "guard", "has", "have", "he",
            ...
            "is", "issues", "it", "its", "jan", "joins", "judge", "killing", "know",
            "large", "late", "latest", "law", "leader", "leaders", "lead", "led",
            "life", "linked", "live", "major", "man", "mark", "massive", "me",
            "measure", "meeting", "million", "more", "morning", "move", "my", "new",
            "news", "night", "no", "north", "not", "of", "off", "office", "officer",
            ...
            "remains", "report", "reports", "response", "risk", "say", "says", "said",
            "second", "security", "seek", "seems", "sell", "services", "set", "she",
            "shes", "shut", "since", "slams", "so", "sources", "spoke", "special",
            "state", "stay", "still", "streets", "suffers", "support", "suspected",
            "taking", "takes", "talk", "talks", "target", "team", "tensions", "than",
            "that", "the", "their", "them", "then", "there", "these", "they", "this",
            "those", "time", "to", "took", "toward", "trumps", "two", "under", "up",
            "update", "updates", "urged", "us", "use", "vehicle", "vehicles", "vote",
            "was", "watch", "way", "we", "were", "what", "when", "where", "which",
            "who", "why", "winds", "with", "woman", "want", "you", "your",
            "near", "people",
