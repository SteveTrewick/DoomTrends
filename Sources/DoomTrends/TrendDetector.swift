...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "from", "get", "government", "has", "have", "he", "her", "high", "his",
            "how", "if", "in", "into", "is", "it", "its", "late", "latest", "live",
            "me", "more", "my", "new", "night", "no", "not", "of", "off", "on", "one",
            "opinion", "or", "our", "out", "over", "patients", "rate", "report",
            "response", "say", "says", "said", "she", "so", "spoke", "state", "than",
            "that", "the", "their", "them", "then", "there", "these", "they", "this",
            "those", "to", "under", "up", "update", "us", "was", "watch", "way", "we",
            "were", "what", "when", "where", "which", "who", "why", "with", "woman",
            "you", "your",
            "business", "leader", "near", "people",
