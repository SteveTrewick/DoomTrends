...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "amid", "an", "and", "agents", "are", "areas", "as", "at", "be", "been",
            "before", "being", "blank", "breaking", "business", "but", "by", "called",
            "calling", "car", "city", "claims", "customs", "death", "defends",
            "department", "disruption", "enforcement", "experience", "explore",
            "extension", "extending", "fatal", "fatally", "federal", "for", "force",
            "former", "forward", "from", "funding", "get", "gets", "good", "got",
            "government", "has", "have", "he", "health", "help", "her", "heres",
            "high", "his", "holds", "homeland", "host", "house", "how", "if", "in",
            "incident", "interview", "into", "investigation", "involved", "is", "it",
            "its", "joins", "judge", "know", "large", "late", "latest", "leader",
            "leaders", "lead", "led", "life", "live", "man", "mark", "massive",
            "me", "measure", "million", "more", "morning", "my", "new", "news",
            "night", "no", "not", "of", "off", "office", "officer", "officers",
            "official", "old", "on", "one", "opinion", "or", "our", "out", "over",
            "party", "pass", "patients", "plan", "powers", "prosecutor", "rate",
            "report", "reports", "response", "say", "says", "said", "security",
            "seek", "sell", "services", "set", "she", "shes", "so", "sources",
            "spoke", "special", "state", "stay", "still", "streets", "support",
            "taking", "takes", "target", "talks", "team", "tensions", "than", "that",
            "the", "their", "them", "then", "there", "these", "they", "this", "those",
            "to", "took", "toward", "trumps", "under", "up", "update", "updates",
            "urged", "us", "vehicle", "vehicles", "vote", "was", "watch", "way", "we",
            "were", "what", "when", "where", "which", "who", "why", "winds", "with",
            "woman", "want", "you", "your",
            "near", "people",
