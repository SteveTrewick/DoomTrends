...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "as", "at", "back", "bar", "be", "been", "before", "being", "blank",
            "border", "breaking", "breaks", "business", "but", "by", "called",
            "calling", "came", "car", "changed", "child", "children", "citizens",
            "city", "claims", "closed", "coast", "cold", "concerns", "conditions",
            "customs", "damage", "death", "deadly", "defends", "department",
            "disruption", "downplay", "enforcement", "eve", "exclusive", "experience",
            "explore", "extension", "extending", "fatal", "fatally", "father",
            "federal", "fire", "flight", "focus", "following", "for", "force",
            "forces", "former", "found", "forward", "from", "funding", "game",
            ...
            "next", "night", "no", "north", "not", "of", "off", "office", "officer",
            "officers", "official", "officials", "old", "on", "one", "opinion", "or",
            "our", "out", "over", "owner", "party", "pass", "patients", "plan",
            "point", "power", "powers", "previously", "property", "prosecutor",
            "rate", "really", "remains", "report", "reporter", "reports", "response",
            "return", "review", "risk", "say", "says", "said", "scrutiny", "second",
            ...
            "warns", "was", "watch", "way", "we", "were", "what", "when", "where",
            "which", "white", "who", "why", "winds", "with", "woman", "want", "you",
            "your",
            "near", "people",
