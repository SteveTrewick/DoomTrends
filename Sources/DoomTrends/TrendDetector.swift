...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            "a", "about", "according", "action", "actions", "after", "against", "all",
            "amid", "an", "and", "agents", "are", "areas", "as", "at", "be", "been",
            "before", "being", "blank", "breaking", "business", "but", "by", "calling",
            "city", "customs", "defends", "department", "disruption", "enforcement",
            "explore", "fatally", "federal", "for", "from", "get", "gets", "good",
            "got", "government", "has", "have", "he", "her", "high", "his", "holds",
            "homeland", "how", "if", "in", "into", "is", "it", "its", "judge", "know",
            "late", "latest", "leader", "lead", "led", "live", "man", "me", "measure",
            "million", "more", "morning", "my", "new", "night", "no", "not", "of",
            "off", "officer", "official", "old", "on", "one", "opinion", "or", "our",
            "out", "over", "patients", "powers", "prosecutor", "rate", "report",
            "response", "say", "says", "said", "security", "she", "so", "spoke",
            "state", "taking", "target", "than", "that", "the", "their", "them", "then",
            "there", "these", "they", "this", "those", "to", "under", "up", "update",
            "updates", "us", "vehicle", "was", "watch", "way", "we", "were", "what",
            "when", "where", "which", "who", "why", "with", "woman", "you", "your",
            "near", "people",
