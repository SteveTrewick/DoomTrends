...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            "a", "about", "according", "across", "action", "actions", "administration",
            "advances", "after", "against", "agency", "agent", "all", "amid", "an",
            "and", "agents", "are", "areas", "as", "at", "be", "been", "before",
            "being", "blank", "breaking", "business", "but", "by", "called",
            "calling", "city", "claims", "customs", "defends", "department",
            "disruption", "enforcement", "experience", "explore", "extension",
            "extending", "fatal", "fatally", "federal", "for", "force", "former",
            "forward", "from", "funding", "get", "gets", "good", "got", "government",
            "has", "have", "he", "health", "help", "her", "heres", "high", "his",
            "holds", "homeland", "host", "house", "how", "if", "in", "incident",
            "interview", "into", "investigation", "is", "it", "its", "joins", "judge",
            "know", "large", "late", "latest", "leader", "leaders", "lead", "led",
            "live", "man", "massive", "me", "measure", "million", "more", "morning",
            "my", "new", "news", "night", "no", "not", "of", "off", "office",
            "officer", "officers", "official", "old", "on", "one", "opinion", "or",
            "our", "out", "over", "party", "pass", "patients", "plan", "powers",
            "prosecutor", "rate", "report", "reports", "response", "say", "says",
            "said", "security", "seek", "sell", "services", "she", "shes", "so",
            "sources", "spoke", "state", "stay", "still", "support", "taking",
            "takes", "target", "talks", "team", "tensions", "than", "that", "the",
            "their", "them", "then", "there", "these", "they", "this", "those",
            "to", "toward", "trumps", "under", "up", "update", "updates", "urged",
            "us", "vehicle", "vehicles", "vote", "was", "watch", "way", "we", "were",
            "what", "when", "where", "which", "who", "why", "with", "woman", "want",
            "you", "your",
            "near", "people",
