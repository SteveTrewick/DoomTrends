...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "against", "agency", "all", "amid", "an", "and", "agents", "are", "areas",
            "as", "at", "be", "been", "before", "being", "blank", "breaking",
            "business", "but", "by", "calling", "city", "customs", "defends",
            "department", "disruption", "enforcement", "explore", "fatally", "federal",
            "for", "former", "from", "get", "gets", "good", "got", "government", "has",
            "have", "he", "help", "her", "heres", "high", "his", "holds", "homeland",
            "how", "if", "in", "incident", "into", "investigation", "is", "it",
            "its", "judge", "know", "late", "latest", "leader", "lead", "led", "live",
            "man", "me", "measure", "million", "more", "morning", "my", "new", "news",
            "night", "no", "not", "of", "off", "officer", "official", "old", "on",
            "one", "opinion", "or", "our", "out", "over", "patients", "powers",
            "prosecutor", "rate", "report", "response", "say", "says", "said",
            "security", "services", "she", "so", "spoke", "state", "taking", "target",
            "talks", "than", "that", "the", "their", "them", "then", "there", "these",
            "they", "this", "those", "to", "under", "up", "update", "updates", "us",
