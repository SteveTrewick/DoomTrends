...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            "a", "about", "according", "action", "actions", "administration", "after",
            "against", "agency", "agent", "all", "amid", "an", "and", "agents", "are",
            "areas", "as", "at", "be", "been", "before", "being", "blank", "breaking",
            "business", "but", "by", "calling", "city", "claims", "customs", "defends",
            "department", "disruption", "enforcement", "explore", "fatal", "fatally",
            "federal", "for", "former", "from", "funding", "get", "gets", "good",
            "got", "government", "has", "have", "he", "health", "help", "her", "heres",
            "high", "his", "holds", "homeland", "house", "how", "if", "in", "incident",
            "into", "investigation", "is", "it", "its", "joins", "judge", "know",
            "late", "latest", "leader", "lead", "led", "live", "man", "massive", "me",
            "measure", "million", "more", "morning", "my", "new", "news", "night",
            "no", "not", "of", "off", "officer", "officers", "official", "old", "on",
            "one", "opinion", "or", "our", "out", "over", "party", "patients",
            "plan", "powers", "prosecutor", "rate", "report", "response", "say",
            "says", "said", "security", "services", "she", "shes", "so", "sources",
            "spoke", "state", "taking", "target", "talks", "tensions", "than",
