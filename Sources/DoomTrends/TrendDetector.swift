...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            "a", "about", "action", "after", "against", "all", "amid", "an", "and",
            "are", "as", "at", "be", "been", "before", "being", "breaking",
            "business", "but", "by", "calling", "customs", "department", "enforcement",
            "federal", "for", "from", "get", "good", "government", "has", "have",
            "he", "her", "high", "his", "holds", "how", "if", "in", "into", "is",
            "it", "its", "judge", "know", "late", "latest", "leader", "led", "live",
            "me", "million", "more", "my", "new", "night", "no", "not", "of", "off",
            "officer", "old", "on", "one", "opinion", "or", "our", "out", "over",
            "patients", "powers", "prosecutor", "rate", "report", "response", "say",
            "says", "said", "she", "so", "spoke", "state", "than", "that", "the",
            "their", "them", "then", "there", "these", "they", "this", "those", "to",
            "under", "up", "update", "us", "vehicle", "was", "watch", "way", "we",
            "were", "what", "when", "where", "which", "who", "why", "with", "woman",
            "you", "your",
            "near", "people",
