...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "seek", "services", "she", "shes", "so", "sources", "spoke", "state",
            "stay", "still", "taking", "takes", "target", "talks", "tensions", "than",
            "that", "the", "their", "them", "then", "there", "these", "they", "this",
            "those", "to", "under", "up", "update", "updates", "urged", "us",
            "vehicle", "was", "watch", "way", "we", "were", "what", "when", "where",
            "which", "who", "why", "with", "woman", "want", "you", "your",
            "near", "people",
