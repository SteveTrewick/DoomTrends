...
public actor TrendDetector {
    public struct Configuration: Sendable, Codable, Hashable {
        ...
        public static let defaultStopwords: Set<String> = [
            ...
            "amid", "an", "and", "agents", "another", "are", "areas", "as", "at",
            "be", "been", "before", "being", "blank", "border", "breaking",
            "business", "but", "by", "called", "calling", "car", "city", "claims",
            "coast", "customs", "damage", "death", "defends", "department",
            "disruption", "enforcement", "exclusive", "experience", "explore",
            "extension", "extending", "fatal", "fatally", "federal", "for", "force",
            "forces", "former", "forward", "from", "funding", "general", "get",
            "gets", "good", "got", "government", "guard", "has", "have", "he",
            "health", "help", "her", "heres", "high", "his", "holds", "homeland",
            "homes", "host", "house", "how", "if", "in", "incident", "interview",
            "into", "investigation", "involved", "is", "issues", "it", "its", "jan",
            "joins", "judge", "know", "large", "late", "latest", "law", "leader",
            "leaders", "lead", "led", "life", "linked", "live", "major", "man",
            "mark", "massive", "me", "measure", "million", "more", "morning", "my",
            "new", "news", "night", "no", "north", "not", "of", "off", "office",
            "officer", "officers", "official", "officials", "old", "on", "one",
            "opinion", "or", "our", "out", "over", "party", "pass", "patients",
            "plan", "power", "powers", "property", "prosecutor", "rate", "report",
            "reports", "response", "say", "says", "said", "security", "seek", "sell",
            "services", "set", "she", "shes", "shut", "since", "so", "sources",
            "spoke", "special", "state", "stay", "still", "streets", "support",
            "suspected", "taking", "takes", "talk", "talks", "target", "team",
            "tensions", "than", "that", "the", "their", "them", "then", "there",
            "these", "they", "this", "those", "to", "took", "toward", "trumps",
            "under", "up", "update", "updates", "urged", "us", "vehicle", "vehicles",
            "vote", "was", "watch", "way", "we", "were", "what", "when", "where",
            "which", "who", "why", "winds", "with", "woman", "want", "you", "your",
            "near", "people",
